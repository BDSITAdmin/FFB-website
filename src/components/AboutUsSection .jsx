        ...
        <section className="relative bg-white px-4 sm:px-6 lg:px-8 py-16">
            <div className="max-w-7xl mx-auto text-center">
                ...
                <div className="mt-10 md:mt-12 mx-auto max-w-4xl">
                    ...
                    <p className="text-[#181818] md:text-[14px] lg:text-[20px] leading-[28px] tracking-[0em] font-normal text-left">
                    ...
                    <div className="mt-8 text-left flex gap-20">
                        <a
                            href="#about"
                            className="lg:w-[249px] lg:h-[48px] px-6 py-[14px] gap-2.5 rotate-0 opacity-100 rounded-full lg:text-[20px] leading-[20px] tracking-[0.02em] bg-[#00622D] text-[#FFFFFF] hover:bg-green-950 flex items-center justify-center font-[Figtree] font-semibold not-italic transition-colors"
                        >
                            Know more About Us
                        </a>
                    </div>
